var CommonService = function () {
    ...
    var productNameModal = function (done, fail, dblCallBack, closeCallback) {
        ...
        function initializeDataTable() {
            ...
            $(dataTableId).DataTable({
                ...
                columns: [
                    ...
                    { data: "Code", title: " Code", width: "10%" },
                    { data: "Name", title: "Name", width: "15%" },
                    { data: "ConversionFactor", title: "ConversionFactor", width: "12%" }
        ...
        $.ajax({
            url: '/Common/Common/_getProductList',
            method: 'get',
        }).done(onSuccess).fail(onFail);
    };
    ...
    var personnelCategoriesNameModal = function (done, fail, dblCallBack, closeCallback) {
        ...
        function initializeDataTable() {
            ...
            $(dataTableId).DataTable({
                ...
                columns: [
                    { data: "Id", visible: false },
                    { data: "SL", title: " SL", width: "10%" },
                    { data: "CategoryOfPersonnel", title: "Category Of Personnel", width: "15%" }
        ...
        $.ajax({
            url: '/Common/Common/_getPersonnelCategoriesList',
            method: 'get',
        }).done(onSuccess).fail(onFail);
    };    
    ...
    return {
        ...
        personnelCategoriesNameModal: personnelCategoriesNameModal
