...
{
    public class ProductIncomeStatementReportController : Controller
    {
        ...
        public ActionResult ProductIncomeStatementReport(BudgetHeaderVM model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                   ...
                   /* string ChargeGroup = ""*/;
                    ...
                    {
                        var ws = package.Workbook.Worksheets.Add("ProductIncome");

                        string ReportHead = CompanyName;
                        string ReportHead2 = "BUDGET FOR PRODUCT INCOME FOR THE YEAR " + YearName;
                        ...
                        using (var memoryStream = new MemoryStream())
                        {
                            ...
                            string fileName = $"ProductIncomeReport_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
