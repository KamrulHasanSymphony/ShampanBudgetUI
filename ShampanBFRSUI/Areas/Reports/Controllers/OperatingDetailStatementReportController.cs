...
{
    public class OperatingDetailStatementReportController : Controller
    {
        ...
        public ActionResult OperatingDetailStatementReport(BudgetHeaderVM model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                   ...
                   /* string ChargeGroup = ""*/;
                    ...
                    resultVM = _repo.OperatingDetailStatementReport(commonVM);
                    ...
                    using (var package = new ExcelPackage())
                    {
                        ...
                        string ReportHead2 = "BUDGET FOR OPERATING DETAILS FOR THE YEAR " + YearName;
                        ...
                        using (var memoryStream = new MemoryStream())
                        {
                            ...
                            string fileName = $"OperatingDetailsReport_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
