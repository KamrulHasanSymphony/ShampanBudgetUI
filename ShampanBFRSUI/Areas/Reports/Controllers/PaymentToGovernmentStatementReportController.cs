...
{
    public class PaymentToGovernmentStatementReportController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                   ...
                   /* string ChargeGroup = ""*/;
                    ...
                    {
                        var ws = package.Workbook.Worksheets.Add("PaymentToGovernmentStatement");

                        string ReportHead = CompanyName;
                        string ReportHead2 = "BUDGET FOR PAYMENT TO GOVERNMENT FOR THE YEAR " + YearName;
                        ...
                        using (var memoryStream = new MemoryStream())
                        {
                            ...
                            string fileName = $"PaymentToGovernmentReport_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
