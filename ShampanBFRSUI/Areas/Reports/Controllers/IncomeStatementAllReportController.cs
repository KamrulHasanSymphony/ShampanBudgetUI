...
{
    public class IncomeStatementAllReportController : Controller
    {
        ...
        public ActionResult IncomeStatementAllReport(BudgetHeaderVM model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                   ...
                   /* string ChargeGroup = ""*/;
                    ...
                    {
                        var ws = package.Workbook.Worksheets.Add("Income Statement All");

                        string ReportHead = CompanyName;
                        string ReportHead2 = "BUDGET FOR INCOME STATEMENT ALL FOR THE YEAR " + YearName;
                        ...
                        using (var memoryStream = new MemoryStream())
                        {
                            ...
                            string fileName = $"IncomeStatementAllReport_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
