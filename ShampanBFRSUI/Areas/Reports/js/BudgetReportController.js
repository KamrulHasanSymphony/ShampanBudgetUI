var BudgetReportController = function (CommonService, CommonAjaxService) {
    ...
    function bindKendoGrid(data) {
        ...
        $("#ReportTypeDetailsData").kendoGrid({
            ...
            toolbar: ["excel"],
            columns: [
                { field: "SL", title: "SL", sortable: true, width: 60, editable: false },
                { field: "IBASCode", title: "iBAS Code", sortable: true, width: 150, editable: false },
                { field: "IBASName", title: "iBAS Name", sortable: true, width: 150, editable: false },
                { field: "SabreCode", title: "Sabre Code", sortable: true, width: 150, editable: false },
                { field: "SabreName", title: "Sabre Name", sortable: true, width: 150, editable: false },
                { field: "Estimated6", title: "Estimated", format: "{0:n2}", sortable: true, width: 150, editable: false },
                { field: "Revised", title: "Revised", format: "{0:n2}", sortable: true, width: 150, editable: false },
                { field: "Approved", title: "Approved", format: "{0:n2}", sortable: true, width: 150, editable: false },
                { field: "Actual_Audited", title: "Actual Audited", format: "{0:n2}", sortable: true, width: 150, editable: false },
                { field: "SixthMonths", title: " 6 Months Actual", format: "{0:n2}", sortable: true, width: 150, editable: false },
                { field: "EstimatedPercent", title: "Estimated %", sortable: true, width: 150, editable: false },
                { field: "RevisedPercent", title: "Revised %", sortable: true, width: 150, editable: false },
                { field: "ActualAuditedPercent", title: "Actual Audited %", sortable: true, width: 150, editable: false },
                { field: "SixthMonthsPercent", title: "6 Months Actual %", sortable: true, width: 150, editable: false }
            ],
            columnMenu: true
        });
    }
