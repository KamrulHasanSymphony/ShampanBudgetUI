...
var BudgetOtherDepartmentAllController = function (CommonService, CommonAjaxService) {
    ...
    var GetGridDataList = function (getTransactionType, getBudgetType) {
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/Ceiling/BudgetOtherDepartmentAll/GetGridDataBudgetAll",
                    type: "POST",
                    dataType: "json",
                    cache: false,
            ...
            columns: [
                {
                    ...
                    template: function (dataItem) {
                        ...
                        return `
        <a href="/Ceiling/BudgetOtherDepartmentAll/Edit?id=${dataItem.Id}&fiscalYearId=${dataItem.FiscalYearId}&budgetType=${dataItem.BudgetType}"
           class="btn btn-primary btn-sm mr-2 edit">
            <i class="fas fa-pencil-alt"></i>
                ...
                { field: "Code", title: "Code", sortable: true, width: 60,hidden:true },
                { field: "YearName", title: "Year Name", width: 200 },
    ...
    function save() {
        ...
        var url = "/Ceiling/BudgetOtherDepartmentAll/CreateEdit";
    ...
    var GetBudgetDetailsData = function () {
        ...
        if (BudgetType != "") {
            var gridDataSource = new kendo.data.DataSource({
                ...
                transport: {
                    read: {
                        url: "/Ceiling/BudgetOtherDepartmentAll/GetBudgetDataForDetailsNew",
                        type: "POST",
                        dataType: "json",
                        cache: false,
