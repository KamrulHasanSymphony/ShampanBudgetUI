...
var BudgetOtherDepartmentController = function (CommonService, CommonAjaxService) {
    ...
    var init = function () {
       ...
       /* getFiscalYearId = $("#FiscalYearId").val() || 0;*/
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/Ceiling/BudgetOtherDepartment/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        ...
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/Ceiling/BudgetOtherDepartment/NextPrevious?id=" + getId + "&status=Next";
            }
        });
                ...
                function (result) {
                    ...
                    if (result) {
                        ...
                        if (model.IsPost == "True") {
                            ...
                            model.IDs = model.Id;
                            var url = "/Ceiling/BudgetOtherDepartment/MultiplePost";
    ...
    var GetGridDataList = function (getTransactionType, getBudgetType) {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/Ceiling/BudgetOtherDepartment/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false,
            ...
            detailInit: function (e) {
                ...
                $("<div/>").appendTo(e.detailCell).kendoGrid({
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: "/Ceiling/BudgetOtherDepartment/GetDetailDataById",
                                type: "GET",
                                dataType: "json",
                                cache: false,
            ...
            columns: [

                {
                    ...
                    template: function (dataItem) {
                        return `
        <a href="/Ceiling/BudgetOtherDepartment/Edit?id=${dataItem.Id}"
    ...
    var GetEditGridDataList = function () {
        ...
        $("#updtBudgetDetailsData").kendoGrid({
            ...
            columns: [
                ...
                { field: "BudgetOtherDepartmentHeaderId", width: 50, hidden: true, editable: true },
    ...
    function save() {
        ...
        var url = "/Ceiling/BudgetOtherDepartment/CreateEdit";
    ...
    function Download() {
        ...
        var form = $('<form method="post" action="/Ceiling/BudgetOtherDepartment/BudgetFinalReport"></form>');
    ...
    var GetBudgetDetailsData = function () {
        ...
        if (BudgetType != "") {
            var gridDataSource = new kendo.data.DataSource({
                ...
                transport: {
                    read: {
                        url: "/Ceiling/BudgetOtherDepartment/GetBudgetDataForDetailsNew",
                        type: "POST",
                        dataType: "json",
                        cache: false,
