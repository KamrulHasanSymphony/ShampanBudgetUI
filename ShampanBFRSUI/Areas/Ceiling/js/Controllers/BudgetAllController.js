...
var BudgetAllController = function (CommonService, CommonAjaxService) {
    ...
    var GetGridDataList = function (getTransactionType, getBudgetType) {
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/Ceiling/BudgetAll/GetGridDataBudgetAll",
                    type: "POST",
                    dataType: "json",
                    cache: false,
            ...
            columns: [
                {
                    ...
                    template: function (dataItem) {
                        ...
                        return `
        <a href="/Ceiling/BudgetAll/Edit?id=${dataItem.Id}&fiscalYearId=${dataItem.FiscalYearId}&budgetType=${dataItem.BudgetType}"
