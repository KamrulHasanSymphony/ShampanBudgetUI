var PersonnelCategoriesController = function (CommonService, CommonAjaxService) {
    ...
    var init = function () {
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/SetUp/ProductGroup/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        ...
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/SetUp/ProductGroup/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    ...
    function SelectData() {
        ...
        var url = "/SetUp/ProductGroup/Delete";
    ...
    var GetGridDataList = function () {
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/SetUp/ProductGroup/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
    ...
    function save() {
        ...
        var url = "/SetUp/ProductGroup/CreateEdit";
